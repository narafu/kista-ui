    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs text-muted-foreground mt-0.5">매매 체결 및 시스템 이벤트 실시간 알림</div>
        </div>
        {hasTelegram && (
      ...
      {hasTelegram && (
        <div className="bg-muted rounded-[10px] px-[14px] py-[12px]">
          <div className="text-xs text-muted-foreground mb-1">연결된 채팅</div>
      ...
      {!hasTelegram && (
        <div className="flex flex-col gap-3">
          <div>
            <div className="text-xs text-muted-foreground mb-1">Bot Token</div>
            <Input
          ...
          <div>
            <div className="text-xs text-muted-foreground mb-1">Chat ID</div>
            <Input

...
export async function loadAssetSnapshotById(id: string, groupId: string | undefined, token: string): Promise<AssetSnapshot | null> {
  const snapshots = await listAssetSnapshots(groupId, token)

...
import { useCreateSystemFinanceCategoryMutation, useUpdateSystemFinanceCategoryMutation } from '@entities/finance'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>{mode === 'edit' ? '공통 카테고리 수정' : '공통 카테고리 추가'}</DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4 py-2">
            {mode === 'create' && (
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger id="systemCategoryParentId" className="w-full h-10" disabled={isPending}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>

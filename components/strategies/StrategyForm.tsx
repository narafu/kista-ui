...
export function StrategyForm({accountId, initial, onSuccess, onCancel}: Props) {
  ...
  }, [accountId, initial, meta.tickers]);
  ...
  useEffect(() => {
    ...
    const newBasePrice = newIsInfinite
      ? (prices?.[newTicker] ?? null)
      : privacyBase;
    const newMinSeed = newIsInfinite
      ? newBasePrice !== null
        ? newBasePrice * 20 * 2 * 1.1
        : null
      : privacyBase !== null
        ? privacyBase / 2
        : null;
    setPct(
      usdDeposit !== null && newMinSeed !== null && usdDeposit < newMinSeed
        ? 0
        : 100,
    );
  }, [
  ...
  const isBelowMinSeed =
    !initial && seedUsd !== null && minSeed !== null && seedUsd < minSeed;
  ...
  return (
    <form onSubmit={handleSubmit}>
        ...
        {initial ? (
          ...
          <div
            style={{
              ...
              overflowX: "auto",
              minWidth: 0,
              padding: "2px 4px", // 첫 종목이 화면 왼쪽에 너무 바짝 붙는 현상 해결
            }}
          >
      ...
      {!initial && (
        ...
        >
          <FieldLabel hint="USD 예수금 기준 · 드래그하거나 입력">
            사용 비율
          </FieldLabel>
      ...
      <div style={{padding: "18px 0 0"}}>
        <FieldLabel hint="">사이클 연속여부</FieldLabel>
      ...
      {/* ── 푸터 버튼 (디자인 싱크 수정 완료) ── */}
      <div
        style={{display: "flex", gap: 10, paddingTop: 24, paddingBottom: 24}}
      >
        {onCancel && (
          <Button
            type="button"

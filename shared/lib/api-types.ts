...
export interface paths {
    ...
    "/api/settings/strategy-suggestions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * 운영전략 추천 목록 변경
         * @description 자산 등록 폼의 운용전략 추천값 목록을 갱신. body: {"suggestions": ["VR", "INFINITE"]}
         */
        put: operations["updateStrategySuggestions"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/finance/transactions": {
        ...
        /**
         * 거래내역 목록 조회
         * @description userId=본인UUID로 필터링하면 개인 탭(내가 입력한 내역만)입니다.
         */
        get: operations["list"];
        put?: never;
        /** 거래내역 등록 */
    ...
    "/api/finance/categories": {
        ...
        /**
         * 카테고리 목록 조회
         * @description 카테고리를 중첩된 트리로 반환합니다.
         */
    ...
    "/api/finance/accounts": {
        ...
        /**
         * 계좌 등록
         * @description 같은 그룹 안에서도 계좌명 중복이 허용됩니다.
         */
    ...
    "/api/admin/finance/categories": {
        ...
        /**
         * 시스템 카테고리 목록 조회
         * @description 그룹 공용 시스템 카테고리를 중첩된 트리로 반환합니다.
         */
    ...
    "/api/finance/transactions/{id}/unshare": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * 거래내역 그룹 공유 해제
         * @description 그룹 공유 거래내역을 개인 소유로 되돌립니다. 같은 그룹 멤버면 누구든 가능합니다.
         */
        patch: operations["unshare"];
        trace?: never;
    };
    "/api/finance/transactions/{id}/share": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * 거래내역 그룹 공유 전환
         * @description 개인 소유 거래내역을 소유자의 현재 그룹으로 공유 전환합니다.
         */
        patch: operations["share"];
        trace?: never;
    };
...
export interface components {
    schemas: {
        ...
        FinanceTransactionResponse: {
            ...
            /**
             * Format: uuid
             * @description 그룹 ID (null이면 개인 소유 — 본인만 조회·전환 가능)
             */
            groupId?: string;
            /**
             * Format: date
        ...
        FinanceCategoryResponse: {
            ...
            system?: boolean;
            /** @description 하위 카테고리 목록 (임의 depth로 재귀 중첩) */
        ...
        BenchmarkFieldRequestEtfBenchmarkSymbol: {
            /** @description 허용 값 목록 */
            allowedValues: ("SPY" | "QQQ" | "QLD" | "IBIT" | "ETHA")[];
            /**
             * @description 비교 기본값
             * @enum {string}
             */
            defaultValue: "SPY" | "QQQ" | "QLD" | "IBIT" | "ETHA";
        };
        BenchmarkRequest: {
            /** @description ETF 벤치마크 비교 자산 설정 */
            etf: components["schemas"]["BenchmarkFieldRequestEtfBenchmarkSymbol"];
        };
        BrokerRequest: {
        ...
        UserResponse: {
            ...
            rejectReason?: string;
            /** @description 자산 등록 폼 운용전략 추천 목록 */
...
export interface operations {
    ...
    updateStrategySuggestions: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StrategySuggestionsRequest"];
            };
        };
        responses: {
            /** @description 변경 성공 */
    ...
    unshare_2: {
        ...
        responses: {
            ...
            /** @description 같은 카테고리에 적용 기간이 겹치는 개인 예산 존재 */
            409: {
                headers: {
                    [name: string]: unknown;
                };

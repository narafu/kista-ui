---
name: "source-command-update-roadmap"
description: "ROADMAP.md에서 완료된 작업을 체크하고 진행 상황을 업데이트합니다"
---

# source-command-update-roadmap

Use this skill when the user asks to run the migrated source command `update-roadmap`.

## Command Template

# Codex 명령어: Update Roadmap
